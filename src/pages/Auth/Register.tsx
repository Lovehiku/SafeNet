...
export function RegisterPage() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      const errorMessage = err?.response?.data?.message || err?.message || 'Registration failed. Please retry.';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-white">
      <div className="card-surface w-full max-w-lg p-8">
        <p className="text-xs uppercase text-primary-600 font-semibold">Join SafeNet</p>
