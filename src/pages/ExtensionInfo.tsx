  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      <div className="flex flex-col gap-2">
        <p className="text-xs uppercase text-primary-600 font-semibold">Browser Shield</p>
        <h1 className="text-3xl font-bold text-gray-900">SafeNet Shield Extension</h1>
      ...
      <div className="card-surface p-6">
        <p className="text-sm font-semibold text-gray-900 mb-2">Installation Instructions</p>
        <ol className="list-decimal list-inside text-sm text-muted space-y-2">
          ...
          <li>Open Chrome and go to <code className="bg-gray-100 px-1 rounded text-gray-900">chrome://extensions/</code></li>
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-muted text-xs">
              <strong className="text-gray-900">Security Note:</strong> The extension only requests minimal permissions necessary for its functionality. All API calls are authenticated and encrypted.
            </p>
          </div>
        </div>
      </Modal>
      ...
      >
        <div className="space-y-4 text-sm">
          ...
          <ol className="list-decimal list-inside space-y-3 text-muted">
            <li>
              <strong className="text-gray-900">Extract the ZIP file</strong>
              <p className="mt-1">Unzip the downloaded file to a location you can easily find (e.g., Desktop or Documents).</p>
            </li>
            <li>
              <strong className="text-gray-900">Open Chrome Extensions</strong>
              <p className="mt-1">Navigate to <code className="bg-gray-100 px-1 rounded text-gray-900">chrome://extensions/</code> in your Chrome browser.</p>
            </li>
            <li>
              <strong className="text-gray-900">Enable Developer Mode</strong>
              <p className="mt-1">Toggle the "Developer mode" switch in the top-right corner of the extensions page.</p>
            </li>
            <li>
              <strong className="text-gray-900">Load the Extension</strong>
              <p className="mt-1">Click "Load unpacked" and select the extracted extension folder (the one containing manifest.json).</p>
            </li>
            <li>
              <strong className="text-gray-900">Login</strong>
              <p className="mt-1">Click the SafeNet Shield icon in your toolbar and login with your SafeNet Guardian account.</p>
            </li>
            <li>
              <strong className="text-gray-900">Enable Protection</strong>
              <p className="mt-1">Make sure the "Protection Enabled" toggle is ON in the extension popup.</p>
            </li>
          </ol>
          <div className="pt-4 border-t border-gray-200">
            <p className="text-muted text-xs">
              <strong className="text-gray-900">Note:</strong> Make sure your SafeNet Guardian backend API is running on <code className="bg-gray-100 px-1 rounded text-gray-900">http://localhost:4000</code> for the extension to work properly.
            </p>
          </div>
        </div>
      </Modal>
